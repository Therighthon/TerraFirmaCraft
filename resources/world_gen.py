...
def generate(rm: ResourceManager):
    ...
    rm.feature(('plant', 'arrowhead'), wg.configure_decorated(plant_feature('tfc:plant/arrowhead[age=1,stage=1,fluid=empty,part=lower]', 'tfc:emergent', 1, 7, 100), decorate_chance(2), 'minecraft:square', decorate_climate(25, 40, 200, 500)))
    ...
    rm.feature(('plant', 'bur_reed'), wg.configure_decorated(plant_feature('tfc:plant/bur_reed[age=1,stage=1,fluid=empty,part=lower]', 'tfc:emergent', 1, 7, 100), decorate_chance(2), 'minecraft:square', decorate_climate(-30, 25, 150, 500)))
    ...
    rm.feature(('plant', 'phragmite'), wg.configure_decorated(plant_feature('tfc:plant/phragmite[age=1,stage=1,fluid=empty,part=lower]', 'tfc:emergent', 1, 7, 100), decorate_chance(2), 'minecraft:square', decorate_climate(-20, 35, 100, 500)))
    rm.feature(('plant', 'pickerelweed'), wg.configure_decorated(plant_feature('tfc:plant/pickerelweed[age=1,stage=1,fluid=empty,part=lower]', 'tfc:emergent', 1, 7, 100), decorate_chance(2), 'minecraft:square', decorate_climate(-30, 25, 150, 500)))
    ...
    rm.feature(('plant', 'water_taro'), wg.configure_decorated(plant_feature('tfc:plant/water_taro[age=1,stage=1,fluid=empty,part=lower]', 'tfc:emergent', 1, 7, 100), decorate_chance(2), 'minecraft:square', decorate_climate(30, 50, 200, 500)))
