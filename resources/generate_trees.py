...
TREES: dict[str, Tree] = {
    'acacia': Tree('acacia', 'koa', 'dead_acacia', None),
    'ash': Tree('aspen', 'thin', 'dead_aspen', None),
    'aspen': Tree('aspen', 'thin', 'dead_aspen', None),
    'birch': Tree('birch', 'emergent', 'dead_aspen', None),
    'blackwood': Tree('blackwood', 'blackwood_large', 'dead_small', None),
    'chestnut': Tree('chestnut', 'normal_large', 'dead_chestnut', None),
    'douglas_fir': Tree('fluffy_conifer', 'fluffy_old_conifer', 'fir_snag', None),
    'hickory': Tree('hickory', 'round_large', 'dead_branching', None),
    'kapok': Tree('jungle', None, 'dead_jungle', None),
    'mangrove': Tree('mangrove', None, 'dead_stump', None),
    'maple': Tree('round', 'round_large', 'dead_small', 'round_riparian'),
    'oak': Tree('pin_oak', None, 'dead_branching', None),
    'palm': Tree('tropical', None, 'dead_palm', None),
    'pine': Tree('red_pine', None, 'pine_snag', None),
    'rosewood': Tree('tall_branches', 'pin_oak', 'dead_branching', None),
    'sequoia': Tree('conifer', 'conifer_large', 'dead_tall', None),
    'spruce': Tree('tall_boreal', None, 'dead_tall', None),
    'sycamore': Tree('medium_round', 'normal_large', 'dead_chestnut', None),
    'white_cedar': Tree('white_cedar', 'tall', 'dead_tall', None),
    'willow': Tree('willow', 'willow_large', 'dead_stump', None),
}
...
def main():
    ...
    for name, tree in TREES.items():
        ...
        make_tree(name, tree.riparian, '_riparian')
