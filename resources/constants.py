...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.entity.tfc.%s.hurt' % fish, '%s hurts' % fish.title().replace('_', ' ')) for fish in (*SIMPLE_FRESHWATER_FISH, 'manatee', 'jellyfish')),
    ...
    # Creative Tabs
    'tfc.creative_mode_tab.tfc_building_blocks': 'TFC Building Blocks',
    'tfc.creative_mode_tab.tfc_colored_blocks': 'TFC Colored Blocks & Items',
    'tfc.creative_mode_tab.tfc_natural_blocks': 'TFC Natural Blocks',
    'tfc.creative_mode_tab.tfc_flora_crops': 'TFC Flora & Crops',
    'tfc.creative_mode_tab.tfc_functional_blocks': 'TFC Functional Blocks',
    'tfc.creative_mode_tab.tfc_tools_utilities': 'TFC Tools & Utilities',
    'tfc.creative_mode_tab.tfc_combat': 'TFC Combat',
    'tfc.creative_mode_tab.tfc_foods_drinks': 'TFC Food & Drinks',
    'tfc.creative_mode_tab.tfc_metals_ingredients': 'TFC Ingredients & Metals',
    'tfc.creative_mode_tab.tfc_spawn_eggs': 'TFC Spawn Eggs',
    # Containers
