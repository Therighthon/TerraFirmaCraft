...
PLANTS: Dict[str, Plant] = {
    ...
    'blue_orchid': Plant(False, 10, 35, 250, 390, 'standard'),
    ...
    'canna': Plant(True, 4, 35, 270, 500, 'standard'),
    'black_orchid': Plant(False, 14, 35, 290, 410, 'standard'),
    'coontail': Plant(False, 2, 18, 250, 500, 'grass_water_fresh'),
    'dandelion': Plant(False, -22, 35, 120, 400, 'standard'),
    'dead_bush': Plant(False, -12, 35, 0, 120, 'dry'),
    'desert_flame': Plant(False, 0, 20, 40, 170, 'standard'),
    'duckweed': Plant(False, -18, 2, 0, 500, 'floating_fresh'),
    'eel_grass': Plant(False, 6, 35, 200, 500, 'grass_water_fresh'),
    'field_horsetail': Plant(False, -12, 20, 300, 500, 'standard'),
    'vriesea': Plant(False, 14, 35, 200, 400, 'epiphyte'),
    ...
    'heliconia': Plant(False, 14, 35, 320, 500, 'standard'),
    ...
    'manatee_grass': Plant(False, 12, 35, 250, 500, 'grass_water'),
    ...
    'pampas_grass': Plant(True, 8, 35, 0, 200, 'tall_grass'),
    ...
    'red_sealing_wax_palm': Plant(False, 18, 35, 280, 500, 'tall_plant'),
    ...
    'ryegrass': Plant(False, -24, 35, 150, 320, 'short_grass'),
    ...
    'guzmania': Plant(False, 20, 35, 290, 480, 'epiphyte'),
    'scutch_grass': Plant(False, 0, 35, 150, 500, 'short_grass'),
    'silver_spurflower': Plant(False, 14, 24, 230, 400, 'standard'),
    'spanish_moss': Plant(False, 8, 22, 400, 500, 'hanging'),
    'star_grass': Plant(False, 2, 35, 50, 260, 'grass_water'),
    ...
    'toquilla_palm': Plant(False, 16, 35, 250, 500, 'tall_plant'),
    'trillium': Plant(False, -10, 8, 250, 500, 'standard'),
    'tropical_milkweed': Plant(False, 8, 24, 120, 300, 'standard'),
    'turtle_grass': Plant(False, 14, 35, 240, 500, 'grass_water'),
    'water_canna': Plant(True, 4, 35, 150, 500, 'floating_fresh'),
    'pistia': Plant(False, 6, 26, 0, 400, 'floating_fresh'),
    'water_lily': Plant(False, -12, 35, 0, 500, 'floating_fresh'),
    'water_taro': Plant(False, 12, 35, 260, 500, 'emergent_fresh'),
