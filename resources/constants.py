...
PLANTS: Dict[str, Plant] = {
    ...
    'guzmania': Plant(False, 20, 32, 290, 480, 'epiphyte'),
    ...
    'manatee_grass': Plant(False, 12, 32, 250, 500, 'grass_water'),
    ...
    'morning_glory': Plant(False, 2, 16, 300, 500, 'creeping'),
    'moss': Plant(False, -10, 32, 250, 500, 'creeping'),
    'nasturtium': Plant(False, 6, 22, 150, 380, 'standard'),
    'orchard_grass': Plant(False, -26, 10, 75, 300, 'short_grass'),
    'ostrich_fern': Plant(False, -14, 6, 290, 470, 'tall_plant'),
    'oxeye_daisy': Plant(False, -14, 10, 120, 300, 'standard'),
    'pampas_grass': Plant(True, 8, 32, 0, 200, 'tall_grass'),
    ...
    'reindeer_lichen': Plant(False, -24, -4, 50, 470, 'creeping'),
    'rose': Plant(True, 2, 14, 150, 300, 'tall_plant'),
    'ryegrass': Plant(False, -24, 32, 150, 320, 'short_grass'),
    ...
    'scutch_grass': Plant(False, 0, 32, 150, 500, 'short_grass'),
    ...
    'star_grass': Plant(False, 2, 32, 50, 260, 'grass_water'),
    ...
    'toquilla_palm': Plant(False, 16, 32, 250, 500, 'tall_plant'),
    'trillium': Plant(False, -10, 8, 250, 500, 'standard'),
    'tropical_milkweed': Plant(False, 8, 22, 120, 300, 'standard'),
    ...
    'turtle_grass': Plant(False, 14, 32, 240, 500, 'grass_water'),
    'vriesea': Plant(False, 14, 32, 200, 400, 'epiphyte'),
    'water_canna': Plant(True, 4, 32, 150, 500, 'floating_fresh'),
    'water_lily': Plant(False, -12, 32, 0, 500, 'floating_fresh'),
    'yucca': Plant(False, -4, 22, 0, 75, 'dry'),
    'arrowhead': Plant(False, -10, 22, 200, 500, 'emergent_fresh'),
    'bur_reed': Plant(False, -16, 4, 250, 400, 'emergent_fresh'),
    'water_taro': Plant(False, 12, 32, 200, 500, 'emergent_fresh'),
    'phragmite': Plant(False, -6, 18, 50, 250, 'emergent_fresh'),
    'pickerelweed': Plant(False, -14, 16, 200, 500, 'emergent_fresh'),
    'red_sealing_wax_palm': Plant(False, 18, 32, 250, 500, 'tall_plant'),
    'hibiscus': Plant(False, 10, 24, 250, 450, 'tall_plant'),
    'heliconia': Plant(False, 14, 35, 300, 500, 'standard'),
    'blue_ginger': Plant(False, 16, 26, 300, 450, 'standard'),
    'king_fern': Plant(False, 18, 35, 350, 500, 'tall_plant'),
    'kangaroo_paw': Plant(False, 14, 35, 100, 300, 'standard'),
    'lilac': Plant(True, -10, 6, 150, 300, 'tall_plant'),
    'silver_spurflower': Plant(False, 14, 24, 250, 400, 'standard'),
    'desert_flame': Plant(False, 0, 20, 40, 170, 'standard'),
    'anthurium': Plant(False, 12, 35, 290, 500, 'standard')
}
