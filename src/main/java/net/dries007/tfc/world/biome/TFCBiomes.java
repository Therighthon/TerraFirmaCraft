...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension CANYONS = register("canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -2, 40)).surface(SimpleSurfaceBuilder.VOLCANIC_SOIL).cinderCones(1, 14, 100, 28).spawnable().type(RiverBlendType.CANYON).noSandyRiverShores()); // Medium height with snake like ridges, minor volcanic activity
    ...
    public static final BiomeExtension VOLCANIC_MOUNTAIN_LAKE = register("volcanic_mountain_lake", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 60)).surface(SimpleSurfaceBuilder.ROCKY_VOLCANIC_SOIL).cinderCones(1, 25, 50, 40).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    public static final BiomeExtension VOLCANIC_OCEANIC_MOUNTAIN_LAKE = register("volcanic_oceanic_mountain_lake", builder().heightmap(seed -> BiomeNoise.mountains(seed, -24, 50)).surface(ShoreAndOceanSurfaceBuilder.VOLCANIC_MOUNTAINS).cinderCones(1, -12, 50, 20).carving(BiomeNoise::undergroundLakes).salty().type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension DOLINE_CANYONS = register("doline_canyons", builder().heightmap(seed -> BiomeNoise.bowlDolines(seed, BiomeNoise.canyons(seed, -2, 34), 15)).surface(SimpleSurfaceBuilder.VOLCANIC_SOIL).cinderCones(1, 14, 100, 28).spawnable().type(RiverBlendType.CANYON).noSandyRiverShores());
    ...
    // Shield Volcanoes
    public static final BiomeExtension ACTIVE_SHIELD_VOLCANO = register("active_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, BiomeNoise.activeHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.ACTIVE).cinderCones(1, 15, 100, 28, true).aquiferHeightOffset(-16).spawnable().type(RiverBlendType.CAVE));
